...
$sendMessage[{newEmbed:{thumbnail:$authorAvatar}{description:Участник **$username[$authorID]** (<@$authorID>) присоединился к серверу}{field:Дата регистрации:<t#COLON#$truncate[$math[($authorID/4194304+1420070400000)/1000]]:D> (<t#COLON#$round[$math[($authorID/4194304+1420070400000)/1000]]#COLON#R>):false}{footer:Id участника#COLON# $authorID:$authorAvatar}{color:#7de848}{timestamp}}]
$else
$sendMessage[{newEmbed:{description:Бот **$username[$authorID]** (<@$authorID>) добавлен на сервер}{color:#ffac51}{footer:Id бота#COLON# $authorID:$authorAvatar}{timestamp}}]
$endif`
}];