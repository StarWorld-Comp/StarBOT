module.exports = {
  ...
  type: "interaction",
  prototype: "slash",
  code: `$interactionReply[{newEmbed:{author:Снятие средств:$get[author.icon]}{thumbnail:$authorAvatar}{description:**$username[$authorID]** забрал **$numberSeparator[$slashOption[amount]]** <#COLON#cheap#COLON#1275714873677975553> из банка.}{color:#2b2d31}{footer:$guildName:$guildIcon}{timestamp}}]
