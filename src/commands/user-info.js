...
1264890302636757037>;none;]}{field:Присоединился:<t#COLON#$truncate[$math[$memberJoinDate[$get[user];$guildID]/1000]]> (<t#COLON#$truncate[$math[$memberJoinDate[$get[user];$guildID]/1000]]#COLON#R>):true}{field:Аккаунт создан:<t#COLON#$truncate[$math[($get[user]/4194304+1420070400000)/1000]]> (<t#COLON#$truncate[$math[($get[user]/4194304+1420070400000)/1000]]#COLON#R>):true}{field:Роли:$replaceText[$userRoles[$get[user];$guildID;mention; ];@everyone;]:false}$nonEscape[$if[$userBanner[$get[user]]!=null;{image:$userBanner[$get[user];4096]}]}]
