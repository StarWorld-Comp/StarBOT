...
1264890302636757037>;none;]}{field:Присоединился:<t#COLON#$truncate[$math[$memberJoinDate[$get[user];$guildID]/1000]]> (<t#COLON#$truncate[$math[$memberJoinDate[$get[user];$guildID]/1000]]#COLON#R>):true}{field:Аккаунт создан:<t#COLON#$truncate[$math[($get[user]/4194304+1420070400000)/1000]]> (<t#COLON#$truncate[$math[($get[user]/4194304+1420070400000)/1000]]#COLON#R>):true}{field:Роли:$replaceText[$userRoles[$get[user];$guildID;mention; ];@everyone;]:false}
$if[$userBanner[$findMember[$slashOption[user];true]]!=null]
{image:$userBanner[$findMember[$slashOption[user];true];4096]}
$endif}]

$let[color;$if[$userBannerColor[$findMember[$slashOption[user];true]]!=]
$userBannerColor[$findMember[$slashOption[user];true]]
$else
#2b2d31
$endif]
