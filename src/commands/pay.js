module.exports = {
  ...
  type: "interaction",
  prototype: "slash",
  code: `$interactionReply[{newEmbed:{author:Перевод участнику:$get[author.icon]}{thumbnail:$userAvatar[$get[user]]}{description:**$username[$authorID]** перевёл **$username[$get[user]]** **$numberSeparator[$get[percent]; ]** <#COLON#cheap#COLON#1275714873677975553>.}{field:<#COLON#comission#COLON#1245987195064680469> Комиссия:На этом сервере комиссия составляет **5 %**:false}
