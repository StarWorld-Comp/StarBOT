module.exports = {
  ...
  type: "interaction",
  prototype: "slash",
  code: `$interactionReply[{newEmbed:{author:Внесение наличных:$get[author.icon]}{thumbnail:$authorAvatar}{description:**$username[$authorID]** положил **$numberSeparator[$slashOption[amount]; ]** <#COLON#cheap#COLON#1275714873677975553> в банк.}
...
$onlyIf[$getUserVar[cash;$authorID]>=$slashOption[amount];{newEmbed:{color:#f1090b}{description:У вас не достаточно наличных для внесения в банк.}{author:Ошибка:$get[error.icon]}{timestamp}}{ephemeral}{interaction}]
