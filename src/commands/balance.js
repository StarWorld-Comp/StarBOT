...
* Ежемесячный бонус (\`/monthly\`)]:true}]
$if[$getUserVar[thiefs;$findUser[$slashOption[user];true];$guildID]!=0;{field:<#COLON#thief#COLON#1275715835004063784> Ограбления:За все свое время участник совершил $getUserVar[thiefs;$findUser[$slashOption[user];true];$guildID] ограблений#COLON# $if[$getUserVar[success_thiefs;$findUser[$slashOption[user];true];$guildID]!=0;
...
* $getUserVar[jail_thiefs;$findUser[$slashOption[user];true];$guildID] ареста]:true}]
