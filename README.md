...
<div style="padding: 10px; background-color: #ffcccb; border-left: 4px solid #f44336;">
  <strong>⚠️ Предупреждение:</strong> Разработка бота была заброшена. Это значит что бот использует устаревшии версии пакетов, а также более не поддерживаемый код!
</div>
