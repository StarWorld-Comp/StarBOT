module.exports = [{
  ...
  type: "interaction",
  prototype: "slash",
  code: `$interactionReply[{newEmbed:{author:Выдача игровой валюты}{thumbnail:$userAvatar[$get[user]]}{description:Вы успешно выдали **$numberSeparator[$slashOption[amount]]** участнику <@$slashOption[user]>.}
