module.exports = [{
  ...
  type: "interaction",
  prototype: "slash",
  code: `$interactionReply[{newEmbed:{author:Регулярный бонус:$get[author.icon]}{thumbnail:$authorAvatar}{description:**$username[$authorID]**, вы забрали свои **500** <#COLON#cheap#COLON#1275714873677975553>.}{field:Следующий бонус можно забрать#COLON#:<t#COLON#$truncate[$sum[$math[$datestamp/1000];43200]]#COLON#R>:false}{color:#2b2d31}{footer:$guildName:$guildIcon}{timestamp}}]
...
<t#COLON#$truncate[$sum[$math[$datestamp/1000];$math[$getCooldownTime[12h;user;timely;$authorID]/1000]]]#COLON#R>.}{author:Ошибка:$get[error.icon]}{timestamp}}{ephemeral}{interaction}]
