module.exports = [{
  ...
  type: "interaction",
  prototype: "slash",
  code: `$interactionReply[{newEmbed:{author:Разблокировка:$get[author.icon]}{thumbnail:$get[avatar]}{field:Модератор:$username (<@$authorID>):true}{field:Причина:$get[reason]:false}{field:Разблокированный участник:$username[$get[user]] (<@$get[user]>):false}{color:#2b2d31}{timestamp}}]
$unban[$guildID;$get[user];$slashOption[reason]]
$if[$isUserDmEnabled[$get[user]]==true;
$sendDM[{newEmbed:{author:Разблокировка:$get[author.icon]}{description:Вы были **разблокированы** модератором **$username[$authorID]** (<@$authorID>)\n\n**Причина**\n$get[reason]}{timestamp}}{actionRow:{button:Отправлено с $guildName[$guildID]:secondary:guild:true:📨}};$get[user];false];]

$onlyPerms[banmembers;{newEmbed:{color:#f1090b}{description:У вас не достаточно прав для разблокировки.}{author:Ошибка:$get[error.icon]}{timestamp}}{ephemeral}{interaction}]
