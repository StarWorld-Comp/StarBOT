module.exports = [{
    name: "resetinvites-guild",
    type: "interaction",
    prototype: "slash",
    $if: "old",
    code: `
$interactionReply[{newEmbed:{description:✅️  Все приглашения в гильдии были успешно удалены.}{timestamp}{footer:Запросил $username[$authorID]:$authorAvatar}{color:#2b2d31}}]
$resetUserVar[bonusinvites;$guildID
